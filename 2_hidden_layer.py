...
def get_parser():
    ...
    parser.add_argument(
        ...
        type = int, 
        default = 10, 
        help = '''the second hidden layer's number of nodes'''
    )
    parser.add_argument(
        '--noise', 
        type=str,
...
class Processor():
    ...
    def __init__(self, arg):
        self.arg = arg
        self.nn_architecture = [{"input_dim" : 2, "output_dim" : arg.number_node1}, {"input_dim" : arg.number_node1, "output_dim" : arg.number_node2}, 
                               {"input_dim": arg.number_node2, "output_dim":1}]
